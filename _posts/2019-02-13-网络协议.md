...
## OSI网络分层模型
  * 七层模型如下：
![七层模型](https://lanbery.github.io/docs/images/2019/network-protocol-layer-model.jpg?raw=true)
<p class="section-indent">
...
OSI的应用层协议包括文件的传输、访问及管理协议(FTAM) ，以及文件虚拟终端协议(VIP)和公用管理系统信息(CMIP)等。
  ...
  * 五层模型
![五层模型](https://lanbery.github.io/docs/images/2019/network-protocol-5model.png?raw=true) 
...
### OSI与TCP/IP的对比
![TCP/IP](https://lanbery.github.io/docs/images/2019/tcpip-np-compare.jpg?raw=true) 
...
## 最后通过一张图读懂隔层协议
![](https://lanbery.github.io/docs/images/2019/tcpip_all.png?raw=true)
